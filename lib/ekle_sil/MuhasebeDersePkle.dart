...
import '../servisler/muhasebe_service.dart';

class MuhasebeDersP extends StatefulWidget {
  const MuhasebeDersP({Key? key}) : super(key: key);

  @override
  State<MuhasebeDersP> createState() => _MuhasebeDersPState();
}

class _MuhasebeDersPState extends State<MuhasebeDersP> {
  ...
  MuhasebeService _muhasebeService= MuhasebeService();
  @override
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          onTap: () {
                            _muhasebeService
                                .addMuhasebeDersPekle(_bolumadiIDController.text ,_gunController.text,_dersadiController.text,_dersOgretmeniController.text,_dersSaatiController.text,_amfiController.text,'')
                                .then((value) {
