...
class SosyalHDersP extends StatefulWidget {
  const SosyalHDersP({Key? key}) : super(key: key);

  @override
  State<SosyalHDersP> createState() => _SosyalHDersPState();


}

class _SosyalHDersPState extends State<SosyalHDersP> {
