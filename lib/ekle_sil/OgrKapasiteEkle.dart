...
class OgrKapasiteEkle extends StatefulWidget {
  const OgrKapasiteEkle({Key? key}) : super(key: key);

  @override
  State<OgrKapasiteEkle> createState() => _OgrKapasiteEkleState();
}

class _OgrKapasiteEkleState extends State<OgrKapasiteEkle> {
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        onTap: () {
                          _kapasiteService
                              .addOgrkapasiteEkle(_kapasiteController.text,'')
                              .then((value) {
